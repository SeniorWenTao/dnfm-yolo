...
class ScrcpyADB:
    def __init__(self, max_width=0, real_width=2336):
        ...
        client = scrcpy.Client(device=devices[0], max_width=max_width)
        # You can also pass an ADBClient instance to it
        adb.connect("adb-24ed1083-yGX7n1._adb-tls-connect._tcp.")
    ...
    def match_and_box(self, frame):
        ...
        try:
            ...
            for obj in result:
                ...
                range_local = [obj.rect.x, obj.rect.y, obj.rect.x + obj.rect.w, obj.rect.y + obj.rect.h]
